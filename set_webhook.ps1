...
$ngrok_url = "https://dares-undrafted-varsity.ngrok-free.dev"
...
# Set webhook
Write-Host "Setting webhook to $ngrok_url/webhook ..."
$wh_body = '{"webhook":{"enabled":true,"url":"' + $ngrok_url + '/webhook","webhook_by_events":false,"webhook_base64":false,"events":["MESSAGES_UPSERT","CONNECTION_UPDATE","MESSAGES_UPDATE"]}}'
