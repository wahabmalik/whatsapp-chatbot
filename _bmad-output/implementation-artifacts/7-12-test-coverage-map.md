# Story 7.12: Test Coverage Map and Epic Baseline Test Count Artifact
...
2. Every Epic 7 story (7-1 through 7-11) has at least one row in the table mapping its primary acceptance criterion to the concrete test file and test class or function that verifies it.
...
- Completed story 7-1 through 7-11 for table row source data: `_bmad-output/implementation-artifacts/7-[1-9]-*.md`, `7-10-*.md`, `7-11-*.md`
- Test files currently in scope: `tests/test_sprint_status_integrity.py`, `tests/test_operational_route_inventory.py`, `tests/test_operator_template_url_contract.py`, `tests/test_docs_runtime_endpoint_contract.py`, `tests/test_reliability.py`, `tests/test_retry_escalation_contract.py`, `tests/test_wa_id_propagation_contract.py`, `tests/test_deferred_delivery_observability.py`, `tests/test_expiring_store.py`, `tests/test_story_1_1_and_1_2.py`, `tests/test_story_5_1_csrf_and_config_write_safety.py`
